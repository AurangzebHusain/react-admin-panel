        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3  bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$63,438.98</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        <div className=" flex m-3 flex-wrap justify-center items-center gap-2">
          {earningData.map((item) => (
            ...
            >
              ...
              <p className="mt-3">
                <span className="text-lg font-se mibold">{item.amount}</span>
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 text-ss">
                    23%
                  </span>
                </p>
